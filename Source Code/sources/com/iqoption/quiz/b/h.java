...
/* compiled from: EmailLayoutBindingImpl */
public class h extends g {
    ...
    static {
        awV.put(c.backArrow, 1);
        awV.put(c.title, 2);
        awV.put(c.email, 3);
        awV.put(c.promocode, 4);
        awV.put(c.next, 5);
    }
    ...
    private h(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (EditText) objArr[3], (TextView) objArr[5], (EditText) objArr[4], (TextView) objArr[2]);
        this.awW = -1;
