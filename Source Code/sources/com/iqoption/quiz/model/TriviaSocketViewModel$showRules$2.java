...
final class TriviaSocketViewModel$showRules$2 extends Lambda implements a<MediatorLiveData<c<Boolean>>> {
    final /* synthetic */ TriviaSocketViewModel this$0;

    TriviaSocketViewModel$showRules$2(TriviaSocketViewModel triviaSocketViewModel) {
        ...
        mediatorLiveData.a(this.this$0.aBO(), new Observer<S>() {
            ...
            public final void onChanged(c<k> cVar) {
                if (cVar != null) {
                    ...
                    mediatorLiveData.setValue(new c(Yt, kVar != null ? Boolean.valueOf(kVar.aAx()) : null, null, null, 12, null));
                }
            }
        });
