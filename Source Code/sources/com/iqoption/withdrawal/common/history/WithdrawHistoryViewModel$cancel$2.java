...
final class WithdrawHistoryViewModel$cancel$2 extends Lambda implements b<Throwable, l> {
    final /* synthetic */ MutableLiveData $cancelWithdrawLiveData;

    WithdrawHistoryViewModel$cancel$2(MutableLiveData mutableLiveData) {
    ...
    public final void q(Throwable th) {
        this.$cancelWithdrawLiveData.setValue(null);
    }
}
