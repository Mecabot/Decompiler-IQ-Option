...
public class ny extends nx {
    ...
    static {
        awU.setIncludes(0, new String[]{"kyc_toolbar_layout"}, new int[]{1}, new int[]{R.layout.kyc_toolbar_layout});
        awV.put(R.id.reportableTitle, 2);
        awV.put(R.id.description, 3);
        awV.put(R.id.yes, 4);
        awV.put(R.id.no, 5);
    }
    ...
    private ny(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[3], (wr) objArr[1], (ConfirmButtonView) objArr[5], (TextView) objArr[2], (ConfirmButtonView) objArr[4]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.ny.hasPendingBindings():boolean");
    }
