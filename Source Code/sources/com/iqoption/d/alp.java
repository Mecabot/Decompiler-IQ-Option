...
public class alp extends alo {
    ...
    static {
        ...
        awV.put(R.id.newLabel, 3);
        awV.put(R.id.watchedLabel, 4);
        awV.put(R.id.duration, 5);
        awV.put(R.id.title, 6);
    }

    public alp(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 7, awU, awV));
    }

    private alp(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
