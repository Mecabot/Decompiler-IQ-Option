...
public class oe extends od {
    ...
    static {
        ...
        awV.put(R.id.emailTitle, 2);
        awV.put(R.id.male, 3);
        awV.put(R.id.female, 4);
    }
    ...
    private oe(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[2], (TextView) objArr[4], (wr) objArr[1], (TextView) objArr[3]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.oe.hasPendingBindings():boolean");
    }
