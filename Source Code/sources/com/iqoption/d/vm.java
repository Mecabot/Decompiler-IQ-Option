...
/* compiled from: HighFrequencyPanelItemBindingImpl */
public class vm extends vl {
    ...
    static {
        awV.put(R.id.signalActive, 1);
        awV.put(R.id.signalValue, 2);
        awV.put(R.id.signalColorLine, 3);
    }
    ...
    private vm(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[1], (View) objArr[3], (TextView) objArr[2]);
        this.awW = -1;
