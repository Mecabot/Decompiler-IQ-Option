...
/* compiled from: PriceMovementsFilterFragmentBindingImpl */
public class agl extends agk {
    ...
    static {
        awV.put(R.id.filterList, 1);
    }

    public agl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 2, awU, awV));
    }

    private agl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
