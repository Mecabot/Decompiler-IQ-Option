...
public class aaf extends aae {
    ...
    private aaf(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ConstraintLayout) objArr[4], (aaw) objArr[2], (RobotoTextView) objArr[8], (TextView) objArr[5], (FrameLayout) objArr[3], (ImageView) objArr[6], (RobotoTextView) objArr[7]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.aaf.hasPendingBindings():boolean");
    }
