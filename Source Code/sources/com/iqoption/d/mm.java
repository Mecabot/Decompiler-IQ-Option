...
public class mm extends ml {
    ...
    static {
        ...
        awV.put(R.id.addressOfResidenceText, 2);
    ...
    private mm(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[2], (LinearLayout) objArr[4], (wr) objArr[1], (ConfirmButtonView) objArr[5], (TextView) objArr[3]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.mm.hasPendingBindings():boolean");
    }
