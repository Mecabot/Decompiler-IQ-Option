...
public class mk extends mj {
    ...
    private mk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (SoftKeyboardEditText) objArr[4], (TextView) objArr[3], (wr) objArr[2], (ConfirmButtonView) objArr[1], (NumPad) objArr[5]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.mk.hasPendingBindings():boolean");
    }
