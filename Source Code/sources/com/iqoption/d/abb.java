...
public class abb extends aba {
    ...
    static {
        ...
        awV.put(R.id.limitPrice, 9);
        awV.put(R.id.invest, 10);
    }

    public abb(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 11, awU, awV));
    }

    private abb(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[5], (TextView) objArr[6], (ConstraintLayout) objArr[4], (aaw) objArr[2], (TextView) objArr[7], (RobotoTextView) objArr[10], (RobotoTextView) objArr[9], (FrameLayout) objArr[3], (ImageView) objArr[8]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.abb.hasPendingBindings():boolean");
    }
