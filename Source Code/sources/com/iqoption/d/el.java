...
public class el extends ej {
    ...
    static {
        ...
        awV.put(R.id.onlineIndicator, 2);
        awV.put(R.id.subtitle, 3);
        awV.put(R.id.typing, 4);
    }
    ...
    private el(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[2], (FormattedTextView) objArr[3], (TextView) objArr[1], (TextView) objArr[4]);
        this.awW = -1;
