...
public class fr extends fq {
    ...
    static {
        awV.put(R.id.titleConfirmDialog, 1);
        awV.put(R.id.type, 2);
        awV.put(R.id.expiration, 3);
        awV.put(R.id.level, 4);
        awV.put(R.id.cancel, 5);
        awV.put(R.id.buy, 6);
    }
    ...
    private fr(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (RobotoTextView) objArr[6], (RobotoTextView) objArr[5], (RobotoTextView) objArr[3], (RobotoTextView) objArr[4], (RobotoTextView) objArr[1], (ImageView) objArr[2]);
        this.awW = -1;
