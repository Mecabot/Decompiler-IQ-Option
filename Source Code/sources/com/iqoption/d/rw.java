...
/* compiled from: FragmentQuizUpdateDelegateBindingImpl */
public class rw extends rv {
    ...
    static {
        ...
        awV.put(R.id.nextGameLabel, 2);
        awV.put(R.id.nextGameDate, 3);
        awV.put(R.id.nextGameTime, 4);
        awV.put(R.id.prizeFundLabel, 5);
        awV.put(R.id.prizeFund, 6);
        awV.put(R.id.updateText, 7);
        awV.put(R.id.btnUpdate, 8);
    }
    ...
    private rw(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[8], (TextView) objArr[3], (TextView) objArr[2], (TextView) objArr[4], (TextView) objArr[6], (TextView) objArr[5], (rl) objArr[1], (TextView) objArr[7]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.rw.hasPendingBindings():boolean");
    }
