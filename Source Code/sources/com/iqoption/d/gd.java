...
/* compiled from: DepositConstructorViewBindingImpl */
public class gd extends gc {
    ...
    static {
        awV.put(R.id.constructorFieldsLayout, 1);
        awV.put(R.id.paymentMethodName, 2);
        awV.put(R.id.depositConstructorTopFrame, 3);
    }
    ...
    private gd(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[1], (FrameLayout) objArr[0], (View) objArr[3], (TextView) objArr[2]);
        this.awW = -1;
