...
public class xh extends xf {
    ...
    static {
        awV.put(R.id.socialTitle, 1);
        awV.put(R.id.facebookLogin, 2);
        awV.put(R.id.googleLogin, 3);
    }
    ...
    private xh(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[2], (LinearLayout) objArr[3], (LinearLayout) objArr[0], (TextView) objArr[1]);
        this.awW = -1;
