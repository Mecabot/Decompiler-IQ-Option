...
public class ag extends af {
    ...
    static {
        awV.put(R.id.proDepositContainer, 1);
        awV.put(R.id.splashView, 2);
    }
    ...
    private ag(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[1], (FrameLayout) objArr[0], (SplashView) objArr[2]);
        this.awW = -1;
