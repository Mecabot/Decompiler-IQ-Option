...
public class ti extends th {
    ...
    static {
        awV.put(R.id.verifyCardsRecyclerView, 1);
        awV.put(R.id.verifyCardsErrorTextView, 2);
        awV.put(R.id.verifyCardsProgress, 3);
    }
    ...
    private ti(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (ContentLoadingProgressBar) objArr[3], (RecyclerView) objArr[1]);
        this.awW = -1;
