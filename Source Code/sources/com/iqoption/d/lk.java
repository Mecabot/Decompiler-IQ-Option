...
/* compiled from: FragmentBalanceSelectionBindingImpl */
public class lk extends lj implements com.iqoption.e.a.a.a {
    @Nullable
    ...
    @Nullable
    private final OnClickListener bwZ;
    private a bxa;
    ...
    public static class a implements OnClickListener {
        ...
        public a b(BalanceSelectionFragment balanceSelectionFragment) {
    ...
    private lk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        ...
        setRootTag(view);
        this.bwZ = new com.iqoption.e.a.a(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if (!(j2 == 0 || balanceSelectionFragment == null)) {
            ...
            onClickListener = aVar.b(balanceSelectionFragment);
        }
        if (j2 != 0) {
        ...
        if ((j & 2) != 0) {
            this.bwL.setOnClickListener(this.bwZ);
        }
    }
