...
public class zp extends zo {
    ...
    static {
        awU.setIncludes(1, new String[]{"micro_portfolio_cfd_info"}, new int[]{2}, new int[]{R.layout.micro_portfolio_cfd_info});
    ...
    private zp(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[5], (TextView) objArr[6], (ConstraintLayout) objArr[4], (zk) objArr[2], (TextView) objArr[9], (TextView) objArr[10], (FrameLayout) objArr[3], (ImageView) objArr[8], (TextView) objArr[7]);
        this.awW = -1;
    ...
    public void invalidateAll() {
        ...
        this.bLM.invalidateAll();
        requestRebind();
    }

    /* JADX WARNING: Missing block: B:8:0x0013, code:
            if (r5.bLM.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.zp.hasPendingBindings():boolean");
    }

    public void setLifecycleOwner(@Nullable LifecycleOwner lifecycleOwner) {
        super.setLifecycleOwner(lifecycleOwner);
        this.bLM.setLifecycleOwner(lifecycleOwner);
    }

    protected boolean onFieldChange(int i, Object obj, int i2) {
        return i != 0 ? false : a((zk) obj, i2);
    }

    private boolean a(zk zkVar, int i) {
        if (i != 0) {
            return false;
        }
        synchronized (this) {
    ...
    protected void executeBindings() {
        ...
        ViewDataBinding.executeBindingsOn(this.bLM);
    }
}
