...
/* compiled from: DepositPageContentBindingSw600dpImpl */
public class gs extends gq {
    @Nullable
    private static final IncludedLayouts awU = new IncludedLayouts(47);
    @Nullable
    private static final SparseIntArray awV = new SparseIntArray();
    private long awW;
    @NonNull
    private final RelativeLayout bqj;
    ...
    static {
        ...
        awV.put(R.id.guidelineIconsTop, 5);
        awV.put(R.id.verifiedByVisa, 6);
        awV.put(R.id.masterCardSecureCode, 7);
        awV.put(R.id.visaBottomLine, 8);
        awV.put(R.id.security3dImage, 9);
        awV.put(R.id.security3dBottomLine, 10);
        awV.put(R.id.sslCertifiedImage, 11);
        awV.put(R.id.sslCertifiedBottomLine, 12);
        awV.put(R.id.fundsImage, 13);
        awV.put(R.id.fundsImageBottomLine, 14);
        awV.put(R.id.guideline_payment_method, 15);
        awV.put(R.id.guideline_left_payment_method, 16);
        awV.put(R.id.guideline_checkbox, 17);
        awV.put(R.id.paymentMethodSpinnerFrame, 18);
        awV.put(R.id.paymentMethodSpinner, 19);
        awV.put(R.id.paymentMethodCheck, 20);
        ...
        awV.put(R.id.paymentMethodTextView, 46);
    }

    public gs(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 47, awU, awV));
    }

    private gs(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[21], (AppCompatCheckBox) objArr[38], (EditText) objArr[32], (ImageView) objArr[34], (ImageView) objArr[33], (TextView) objArr[31], (TextView) objArr[30], (TextView) objArr[40], (TextView) objArr[39], (View) objArr[44], (TextView) objArr[41], (TextView) objArr[43], (ImageView) objArr[26], (AppCompatSpinner2) objArr[24], (TextView) objArr[25], (EditText) objArr[22], (AppCompatImageView) objArr[35], (RadioGroupNested) objArr[29], (ConfirmButtonView) objArr[28], (ConfirmButtonView) objArr[23], (RobotoTextView) objArr[27], (RelativeLayout) objArr[0], (TextView) objArr[45], (LinearLayout) objArr[42], (ImageView) objArr[13], (View) objArr[14], (View) objArr[17], (View) objArr[5], (View) objArr[3], (View) objArr[4], (View) objArr[16], (View) objArr[15], (ImageView) objArr[7], (ImageView) objArr[20], (AppCompatSpinner2) objArr[19], (FrameLayout) objArr[18], (TextView) objArr[46], (View) objArr[10], (ImageView) objArr[9], (View) objArr[12], (ImageView) objArr[11], (hl) objArr[2], (TextView) objArr[36], (TextView) objArr[37], (ImageView) objArr[6], (View) objArr[8]);
        this.awW = -1;
        this.bpK.setTag(null);
        this.bqj = (RelativeLayout) objArr[1];
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.gs.hasPendingBindings():boolean");
    }
