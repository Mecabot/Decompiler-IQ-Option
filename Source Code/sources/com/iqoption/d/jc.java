...
public class jc extends jb implements a {
    @Nullable
    ...
    private long awW;
    @Nullable
    private final OnClickListener bti;
    ...
    static {
        ...
        awV.put(R.id.scheduleTitle, 2);
        awV.put(R.id.scheduleList, 3);
    }
    ...
    private jc(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        ...
        setRootTag(view);
        this.bti = new com.iqoption.e.a.a(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        bw bwVar = this.bth;
        if ((j & 2) != 0) {
            this.brJ.setOnClickListener(this.bti);
        }
    }

    public final void a(int i, View view) {
        bw bwVar = this.bth;
        if ((bwVar != null ? 1 : null) != null) {
            bwVar.onClose();
        }
    }
}
