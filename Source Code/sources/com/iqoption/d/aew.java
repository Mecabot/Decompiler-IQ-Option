...
public class aew extends aev {
    ...
    public aew(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 11, awU, awV));
    }

    private aew(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.aew.hasPendingBindings():boolean");
    }
