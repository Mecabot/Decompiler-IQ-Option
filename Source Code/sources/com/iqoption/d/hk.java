...
/* compiled from: DepositPaymentUnsuccessfulCompletedBindingImpl */
public class hk extends hj {
    ...
    static {
        ...
        awV.put(R.id.tryAgainOrContactSupport, 2);
        awV.put(R.id.errorMessage, 3);
        awV.put(R.id.tryAgainButton, 4);
    }
