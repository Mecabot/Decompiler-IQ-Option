...
public class aal extends aak {
    ...
    static {
        awV.put(R.id.totalValueLabel, 1);
        awV.put(R.id.totalValue, 2);
        awV.put(R.id.totalPnlLabel, 3);
        awV.put(R.id.totalPnl, 4);
    }

    public aal(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 5, awU, awV));
    }

    private aal(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
