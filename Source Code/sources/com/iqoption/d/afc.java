...
public class afc extends afb {
    ...
    public afc(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 4, awU, awV));
    }

    private afc(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
