...
public class ng extends nf {
    ...
    static {
        ...
        awV.put(R.id.phone, 4);
        awV.put(R.id.numPad, 5);
    }
    ...
    private ng(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (wr) objArr[2], (ConfirmButtonView) objArr[1], (NumPad) objArr[5], (SoftKeyboardEditText) objArr[4], (TextView) objArr[3]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.ng.hasPendingBindings():boolean");
    }
