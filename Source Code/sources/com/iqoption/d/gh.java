...
/* compiled from: DepositCurrencyItemBindingImpl */
public class gh extends gg {
    ...
    static {
        awV.put(R.id.currencySymbol, 1);
        awV.put(R.id.currencyText, 2);
    }
    ...
    private gh(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (RobotoTextView) objArr[1], (TextView) objArr[2]);
        this.awW = -1;
