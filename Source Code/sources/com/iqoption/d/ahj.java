...
public class ahj extends ahi {
    ...
    static {
        awV.put(R.id.activeImage, 1);
        awV.put(R.id.activeOpenTime, 2);
    }

    public ahj(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private ahj(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (RobotoTextView) objArr[2]);
        this.awW = -1;
