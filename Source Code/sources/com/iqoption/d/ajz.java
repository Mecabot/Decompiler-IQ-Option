...
/* compiled from: StringBasketRemoveAllItemBindingImpl */
public class ajz extends ajy {
    ...
    protected void executeBindings() {
        ...
        if ((j & 1) != 0) {
            TextViewBindingAdapter.setDrawableLeft(this.aig, ViewDataBinding.getDrawableFromResource(this.aig, R.drawable.ic_basket2_white));
        }
    }
}
