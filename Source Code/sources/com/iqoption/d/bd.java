...
/* compiled from: BitcoinWhatsNewDialogBindingImpl */
public class bd extends bc implements a {
    @Nullable
    ...
    @Nullable
    private final OnClickListener blo;
    ...
    private bd(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[3], (TextView) objArr[4], (ImageView) objArr[1], (FormattedTextView) objArr[2]);
        this.awW = -1;
        this.axx = (LinearLayout) objArr[0];
        this.axx.setTag(null);
        this.bll.setTag(null);
        setRootTag(view);
        this.blo = new com.iqoption.e.a.a(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((j & 2) != 0) {
            this.bll.setOnClickListener(this.blo);
        }
    }
