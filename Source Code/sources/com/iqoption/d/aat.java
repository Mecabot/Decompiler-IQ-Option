...
public class aat extends aas {
    ...
    public aat(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 1, awU, awV));
    }

    private aat(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
