...
public class aga extends afz {
    ...
    public aga(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 9, awU, awV));
    }

    private aga(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ConstraintLayout) objArr[4], (afx) objArr[2], (RobotoTextView) objArr[8], (RobotoTextView) objArr[7], (TextView) objArr[5], (FrameLayout) objArr[3], (ImageView) objArr[6]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.aga.hasPendingBindings():boolean");
    }
