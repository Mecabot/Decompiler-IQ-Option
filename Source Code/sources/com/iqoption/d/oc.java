...
public class oc extends ob {
    ...
    private oc(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (wr) objArr[1], (ContentLoadingProgressBar) objArr[3], (WebView) objArr[2]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.oc.hasPendingBindings():boolean");
    }
