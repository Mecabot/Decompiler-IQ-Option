...
public class mo extends mn {
    ...
    private mo(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (wr) objArr[1], (ConfirmButtonView) objArr[3], (TextView) objArr[2]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.mo.hasPendingBindings():boolean");
    }
