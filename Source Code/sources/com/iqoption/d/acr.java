...
public class acr extends acq {
    ...
    static {
        awV.put(R.id.icon, 1);
        awV.put(R.id.operation_name, 2);
        awV.put(R.id.operation_date, 3);
        awV.put(R.id.amount, 4);
        awV.put(R.id.operation_status, 5);
    }
    ...
    private acr(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[4], (ImageView) objArr[1], (TextView) objArr[3], (TextView) objArr[2], (TextView) objArr[5]);
        this.awW = -1;
