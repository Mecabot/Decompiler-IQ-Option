...
/* compiled from: DepositPageAmountItemBindingImpl */
public class gn extends gm {
    ...
    static {
        ...
        awV.put(R.id.vipBadge, 2);
        awV.put(R.id.depositPageAmountItemTopFrame, 3);
        awV.put(R.id.depositPageAmountItemTopFrameBorder, 4);
    }
    ...
    private gn(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[1], (View) objArr[3], (ImageView) objArr[4], (AppCompatImageView) objArr[2]);
        this.awW = -1;
