...
public class nu extends nt {
    ...
    private nu(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (wr) objArr[1], (RobotoTextView) objArr[4], (TextView) objArr[2], (RobotoTextView) objArr[3]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.nu.hasPendingBindings():boolean");
    }
