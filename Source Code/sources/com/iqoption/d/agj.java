...
public class agj extends agi {
    ...
    static {
        awV.put(R.id.priceMovementsAttentionLayout, 1);
        awV.put(R.id.iUnderstand, 2);
    }

    public agj(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, awU, awV));
    }

    private agj(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
