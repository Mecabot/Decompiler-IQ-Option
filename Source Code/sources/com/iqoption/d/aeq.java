...
public class aeq extends aep {
    ...
    public aeq(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 1, awU, awV));
    }

    private aeq(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
