...
/* compiled from: DialogConfirmClosePendingPositionBindingImpl */
public class ii extends ih {
    ...
    static {
        ...
        awV.put(R.id.text, 2);
        awV.put(R.id.btnCancel, 3);
        awV.put(R.id.btnConfirm, 4);
    }
    ...
    private ii(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[3], (TextView) objArr[4], (MaxSizeCardViewLayout) objArr[1], (RobotoTextView) objArr[2]);
        this.awW = -1;
