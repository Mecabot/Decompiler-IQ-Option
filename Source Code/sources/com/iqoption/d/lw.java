...
public class lw extends lv {
    ...
    static {
        ...
        awV.put(R.id.kycAcceptableDocumentsAddress, 3);
    }
    ...
    private lw(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (LinearLayout) objArr[3], (wr) objArr[2]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.lw.hasPendingBindings():boolean");
    }
