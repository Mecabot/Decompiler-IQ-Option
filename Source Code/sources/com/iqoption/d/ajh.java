...
/* compiled from: SignalLatestItemBindingImpl */
public class ajh extends ajg {
    ...
    public ajh(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 1, awU, awV));
    }

    private ajh(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
