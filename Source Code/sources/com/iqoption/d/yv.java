...
public class yv extends yu {
    ...
    static {
        ...
        awV.put(R.id.main_container, 3);
        awV.put(R.id.user_icon, 4);
        awV.put(R.id.author, 5);
        awV.put(R.id.tweet_text, 6);
        awV.put(R.id.topics_container, 7);
        awV.put(R.id.time_text, 8);
    }
    ...
    private yv(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (TextView) objArr[5], (kr) objArr[2], (kv) objArr[1], (ConstraintLayout) objArr[3], (TextView) objArr[8], (TagLayout) objArr[7], (TextView) objArr[6], (ImageView) objArr[4]);
        this.awW = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.yv.hasPendingBindings():boolean");
    }
