...
/* compiled from: DepositCardProcessingPageBindingImpl */
public class fz extends fy {
    ...
    static {
        ...
        awV.put(R.id.cardProcessingContentFrame, 5);
    }
    ...
    private fz(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ScrollView) objArr[5], (ImageView) objArr[4], (TextView) objArr[3], (View) objArr[2], (View) objArr[1]);
        this.awW = -1;
