...
/* compiled from: DepositPaymentSuccessfullyCompletedBindingImpl */
public class hi extends hh {
    ...
    static {
        awV.put(R.id.progressIcon, 1);
        awV.put(R.id.depositTitle, 2);
        awV.put(R.id.startTradingButton, 3);
    }
    ...
    private hi(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (AppCompatImageView) objArr[1], (TextView) objArr[3]);
        this.awW = -1;
