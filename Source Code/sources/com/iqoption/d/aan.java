...
public class aan extends aam {
    ...
    public aan(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 5, awU, awV));
    }

    private aan(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
