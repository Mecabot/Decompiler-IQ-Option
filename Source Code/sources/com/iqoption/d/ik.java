...
/* compiled from: DialogConfirmSellPositionBindingImpl */
public class ik extends ij {
    ...
    static {
        ...
        awV.put(R.id.cancel, 3);
        awV.put(R.id.confirm, 4);
    }
    ...
    private ik(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (RobotoTextView) objArr[3], (RobotoTextView) objArr[4], (MaxSizeCardViewLayout) objArr[1], (RobotoTextView) objArr[2]);
        this.awW = -1;
