...
public class am extends al {
    ...
    static {
        awV.put(R.id.content, 1);
        awV.put(R.id.introStub, 2);
        awV.put(R.id.ic_cysec, 3);
        awV.put(R.id.introLogo, 4);
    }
    ...
    private am(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[1], (ImageView) objArr[3], (ImageView) objArr[4], (FrameLayout) objArr[2]);
        this.awW = -1;
