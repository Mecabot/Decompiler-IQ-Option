...
public class agc extends agb {
    ...
    static {
        ...
        awV.put(R.id.sideIndicator, 9);
        awV.put(R.id.limitPrice, 10);
        awV.put(R.id.invest, 11);
    }

    public agc(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 12, awU, awV));
    }

    private agc(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[5], (TextView) objArr[6], (ConstraintLayout) objArr[4], (afx) objArr[2], (TextView) objArr[7], (RobotoTextView) objArr[11], (RobotoTextView) objArr[10], (TextView) objArr[8], (FrameLayout) objArr[3], (ImageView) objArr[9]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.agc.hasPendingBindings():boolean");
    }
