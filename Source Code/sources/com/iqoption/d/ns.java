...
public class ns extends nr {
    ...
    static {
        ...
        awV.put(R.id.warningText, 2);
        awV.put(R.id.riskDisclosure, 3);
        awV.put(R.id.nextButton, 4);
    }
    ...
    private ns(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (wr) objArr[1], (ConfirmButtonView) objArr[4], (TextView) objArr[3], (TextView) objArr[2]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.ns.hasPendingBindings():boolean");
    }
