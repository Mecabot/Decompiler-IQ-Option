...
/* compiled from: OpenBinaryOptionGroupItemBindingImpl */
public class abz extends aby {
    @Nullable
    private static final IncludedLayouts awU = new IncludedLayouts(20);
    @Nullable
    ...
    static {
        ...
        awV.put(R.id.sellingPriceLayout, 16);
        awV.put(R.id.sellingPriceText, 17);
        awV.put(R.id.sellingPriceValue, 18);
        awV.put(R.id.divider, 19);
    }

    public abz(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private abz(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[10], (TextView) objArr[15], (TextView) objArr[13], (FrameLayout) objArr[3], (LinearLayout) objArr[4], (RobotoTextView) objArr[7], (agg) objArr[1], (FormattedTextView) objArr[5], (View) objArr[19], (ContentLoadingProgressBar) objArr[6], (ImageView) objArr[12], (FrameLayout) objArr[2], (LinearLayout) objArr[8], (LinearLayout) objArr[0], (FormattedTextView) objArr[14], (LinearLayout) objArr[16], (TextView) objArr[17], (RobotoTextView) objArr[18], (TimerView) objArr[9], (RobotoTextView) objArr[11]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.abz.hasPendingBindings():boolean");
    }
