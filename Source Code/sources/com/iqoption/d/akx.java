...
public class akx extends akw {
    ...
    public akx(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 1, awU, awV));
    }

    private akx(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
