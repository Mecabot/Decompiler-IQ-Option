...
public class aad extends aac {
    ...
    static {
        awU.setIncludes(1, new String[]{"micro_portfolio_exp_info"}, new int[]{2}, new int[]{R.layout.micro_portfolio_exp_info});
    ...
    private aad(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[6], (ConstraintLayout) objArr[4], (zy) objArr[2], (TextView) objArr[9], (TextView) objArr[10], (FrameLayout) objArr[3], (ImageView) objArr[8], (TimerView) objArr[5], (TextView) objArr[7]);
        this.awW = -1;
    ...
    public void invalidateAll() {
        ...
        this.bLX.invalidateAll();
        requestRebind();
    }

    /* JADX WARNING: Missing block: B:8:0x0013, code:
            if (r5.bLX.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.aad.hasPendingBindings():boolean");
    }

    public void setLifecycleOwner(@Nullable LifecycleOwner lifecycleOwner) {
        super.setLifecycleOwner(lifecycleOwner);
        this.bLX.setLifecycleOwner(lifecycleOwner);
    }

    protected boolean onFieldChange(int i, Object obj, int i2) {
        return i != 0 ? false : a((zy) obj, i2);
    }

    private boolean a(zy zyVar, int i) {
        if (i != 0) {
            return false;
        }
        synchronized (this) {
    ...
    protected void executeBindings() {
        ...
        ViewDataBinding.executeBindingsOn(this.bLX);
    }
}
