...
public class cz extends cy {
    ...
    static {
        awV.put(R.id.fileList, 1);
        awV.put(R.id.topBar, 2);
    ...
    private cz(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[3], (RecyclerView) objArr[1], (TextView) objArr[4], (LinearLayout) objArr[2]);
        this.awW = -1;
