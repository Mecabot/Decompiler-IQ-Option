...
public class nk extends nj {
    ...
    private nk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (wr) objArr[2], (wp) objArr[3], (TextView) objArr[4]);
        this.awW = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.nk.hasPendingBindings():boolean");
    }
