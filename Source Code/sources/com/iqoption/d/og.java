...
public class og extends of {
    ...
    static {
        ...
        awV.put(R.id.finishIcon, 2);
        awV.put(R.id.nextButton, 3);
    }
    ...
    private og(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[2], (wr) objArr[1], (ConfirmButtonView) objArr[3]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.og.hasPendingBindings():boolean");
    }
