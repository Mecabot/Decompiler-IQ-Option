...
public class ly extends lx {
    ...
    static {
        ...
        awV.put(R.id.addressTitle, 4);
        awV.put(R.id.addressLine1, 5);
        awV.put(R.id.addressLine2, 6);
    }
    ...
    private ly(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (SoftKeyboardEditText) objArr[5], (SoftKeyboardEditText) objArr[6], (TextView) objArr[4], (wr) objArr[2], (wp) objArr[3]);
        this.awW = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.ly.hasPendingBindings():boolean");
    }
