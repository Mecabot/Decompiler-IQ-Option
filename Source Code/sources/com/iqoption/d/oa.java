...
public class oa extends nz {
    ...
    private oa(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (FormattedTextView) objArr[2], (wr) objArr[1]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.oa.hasPendingBindings():boolean");
    }
