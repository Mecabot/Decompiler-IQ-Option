...
public class ni extends nh {
    ...
    static {
        ...
        awV.put(R.id.code, 4);
        awV.put(R.id.notReceivedCodeText, 5);
        awV.put(R.id.resendTime, 6);
        awV.put(R.id.resend, 7);
        awV.put(R.id.numPad, 8);
    }
    ...
    private ni(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (SoftKeyboardEditText) objArr[4], (FormattedTextView) objArr[3], (wr) objArr[2], (ConfirmButtonView) objArr[1], (TextView) objArr[5], (NumPad) objArr[8], (TextView) objArr[7], (TextView) objArr[6]);
        this.awW = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.d.ni.hasPendingBindings():boolean");
    }
