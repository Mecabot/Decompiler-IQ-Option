...
public class aaj extends aai {
    ...
    public aaj(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 1, awU, awV));
    }

    private aaj(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
