...
@i(aXC = {1, 1, 11}, aXD = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\"\u0010\u0005\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0016J\b\u0010\f\u001a\u00020\rH\u0016J\b\u0010\u000e\u001a\u00020\u000fH\u0016J\b\u0010\u0010\u001a\u00020\u0011H\u0016¨\u0006\u0012"}, aXE = {"Lcom/iqoption/tutorial/strategy/AddTabStrategy;", "Lcom/iqoption/tutorial/strategy/TutorialStrategy;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "calculatePosition", "Lcom/iqoption/tutorial/utils/TrainingPosition;", "activity", "Landroid/app/Activity;", "pointer", "Landroid/view/View;", "dialog", "dialogOrientation", "Lcom/iqoption/tutorial/utils/DialogOrientation;", "message", "", "pointerRotation", "Lcom/iqoption/tutorial/utils/PointerRotation;", "IqOption-5.5.1_optionXRelease"})
/* compiled from: AddTabStrategy.kt */
public final class a extends j {
    ...
    public String message() {
        String string = getContext().getString(R.string.explore_the_available_trading_instrument);
        if (string == null) {
            h.aXZ();
        }
        return string;
    ...
    public b a(Activity activity, View view, View view2) {
        ...
        h.e(view, "pointer");
        h.e(view2, "dialog");
        View a = a(activity, R.id.addButton);
        if (a == null) {
            return null;
        }
        Point bQ = bQ(a);
        float width = (((float) bQ.x) + (((float) a.getWidth()) * 0.75f)) - (((float) view.getWidth()) * 0.44f);
        ...
        float width2 = (((float) bQ.x) + (((float) a.getWidth()) / 2.0f)) - ((float) dimensionPixelOffset);
        int i = (int) width;
