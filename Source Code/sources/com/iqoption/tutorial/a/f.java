...
public final class f extends j {
    ...
    public String message() {
        String string = getContext().getString(R.string.each_instrument_offers_a_unique_trading_experience);
        if (string == null) {
            h.aXZ();
        }
        return string;
    ...
    public b a(Activity activity, View view, View view2) {
        ...
        int width = (bQ.x + a.getWidth()) - resources.getDimensionPixelOffset(R.dimen.dp4);
        float f = ((float) (bQ.y + dimensionPixelOffset)) - height;
        return new b(new Point(width, (int) f), new Point(width, (int) (((float) (bQ.y + a.getHeight())) - height)), new Point(view.getWidth() + width, (int) (((float) dimensionPixelOffset) + f)));
    }
}
