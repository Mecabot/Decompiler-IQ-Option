...
/* compiled from: LayoutDepositToolbarBindingImpl */
public class bt extends bs {
    ...
    static {
        awV.put(f.toolbarBack, 2);
        awV.put(f.depositTitle, 3);
        awV.put(f.toolbarDepositContainer, 4);
        awV.put(f.toolbarProgress, 5);
    }
    ...
    private bt(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[3], (ImageView) objArr[2], (TextView) objArr[1], (FrameLayout) objArr[4], (ContentLoadingProgressBar) objArr[5]);
        this.awW = -1;
