...
public class cb extends bz {
    ...
    static {
        awV.put(f.depositPerformLightTitle, 2);
    }
    ...
    private cb(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (LinearLayout) objArr[1], (LinearLayout) objArr[0]);
        this.awW = -1;
        this.bqH.setTag(null);
        this.caw.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
