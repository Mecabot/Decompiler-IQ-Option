...
/* compiled from: ItemPaymentMethodBindingImpl */
public class ap extends ao {
    ...
    static {
        ...
        awV.put(f.methodChecked, 3);
        awV.put(f.methodBlocked, 4);
    }
    ...
    private ap(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[4], (ImageView) objArr[3], (LinearLayout) objArr[0], (ImageView) objArr[1], (TextView) objArr[2]);
        this.awW = -1;
