...
public class l extends k {
    ...
    static {
        ...
        awV.put(f.cardHolderName, 5);
        awV.put(f.cardMonthAndYear, 6);
        awV.put(f.cardCvv, 7);
    }
    ...
    private l(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (EditText) objArr[7], (LinearLayout) objArr[0], (EditText) objArr[5], (EditText) objArr[6], (EditText) objArr[2], (ImageView) objArr[3], (ToggleButton) objArr[1], (ImageView) objArr[4]);
        this.awW = -1;
