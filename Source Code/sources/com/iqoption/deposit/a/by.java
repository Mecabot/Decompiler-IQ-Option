...
/* compiled from: LayoutPayMethodSelectorBindingImpl */
public class by extends bx {
    ...
    static {
        awV.put(f.depositWithText, 2);
        awV.put(f.payMethodSelector, 3);
        awV.put(f.payMethodSelectorIcon, 4);
        awV.put(f.separator, 5);
    }
    ...
    private by(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (TextView) objArr[3], (LinearLayout) objArr[1], (ImageView) objArr[4], (ConstraintLayout) objArr[0], (View) objArr[5]);
        this.awW = -1;
