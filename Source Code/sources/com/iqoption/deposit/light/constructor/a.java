...
import com.iqoption.deposit.a.aa;
...
public final class a extends com.iqoption.deposit.constructor.a {
    ...
    private final void a(aa aaVar) {
        this.bXo.a(this, apP[0], aaVar);
    }

    private final aa adk() {
        return (aa) this.bXo.b(this, apP[0]);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        a((aa) com.iqoption.core.ext.a.a((Fragment) this, g.fragment_payment_fields_light, viewGroup, false, 4, null));
        return adk().getRoot();
    }
    ...
    protected c b(String str, ExtraParamProperty extraParamProperty, ViewGroup viewGroup, boolean z, boolean z2) {
        ...
        return new b((com.iqoption.deposit.a.g) com.iqoption.core.ext.a.a(viewGroup, g.constructor_text_edit_field_light, null, false, 6, null), extraParamProperty, str, z);
    }
    ...
    protected com.iqoption.deposit.constructor.d b(String str, com.iqoption.core.microservices.billing.response.extraparams.a aVar, ViewGroup viewGroup, boolean z) {
        ...
        kotlin.jvm.internal.h.e(viewGroup, "container");
        return new c((com.iqoption.deposit.a.c) com.iqoption.core.ext.a.a(viewGroup, g.constructor_spinner_field_light, null, false, 6, null), aVar, str, z);
    }

    protected e b(String str, com.iqoption.core.microservices.billing.response.extraparams.c cVar, ViewGroup viewGroup, boolean z) {
        kotlin.jvm.internal.h.e(str, "name");
        kotlin.jvm.internal.h.e(cVar, "property");
        kotlin.jvm.internal.h.e(viewGroup, "container");
        return new d((com.iqoption.deposit.a.c) com.iqoption.core.ext.a.a(viewGroup, g.constructor_spinner_field_light, null, false, 6, null), cVar, str, z);
    }

    protected h a(com.iqoption.deposit.constructor.selector.integer.c cVar) {
        kotlin.jvm.internal.h.e(cVar, "params");
        return com.iqoption.deposit.light.constructor.selector.integer.c.caL.b(cVar);
    }

    protected h a(com.iqoption.deposit.constructor.selector.string.d dVar) {
        kotlin.jvm.internal.h.e(dVar, "params");
        return com.iqoption.deposit.light.constructor.selector.string.c.caN.b(dVar);
    }
}
