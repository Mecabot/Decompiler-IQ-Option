...
public final class a extends Adapter<b> {
    ...
    public b onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        ViewDataBinding inflate = DataBindingUtil.inflate(LayoutInflater.from(viewGroup.getContext()), g.item_scan_card_light, viewGroup, false);
        h.d(inflate, "DataBindingUtil.inflate(…ard_light, parent, false)");
        return new b((bc) inflate, this.bYl);
    }
