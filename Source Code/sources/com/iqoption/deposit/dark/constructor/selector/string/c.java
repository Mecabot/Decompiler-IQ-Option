...
public final class c extends com.iqoption.bottomsheet.a<g> implements com.iqoption.deposit.constructor.selector.string.a {
    ...
    private HashMap atz;
    private final d bWq = g.f(new SelectorStringMenuDarkFragment$navigator$2(this));
    private final d bXY = g.f(new SelectorStringMenuDarkFragment$params$2(this));
