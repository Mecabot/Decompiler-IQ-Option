    ...
    public static SwEnum getSW(byte[] bArr) {
        if (bArr != null && bArr.length >= 2) {
            for (SwEnum swEnum : values()) {
                if (swEnum.status.length == 1 && bArr[bArr.length - 2] == swEnum.status[0]) {
                    return swEnum;
                }
                if (bArr[bArr.length - 2] == swEnum.status[0] && bArr[bArr.length - 1] == swEnum.status[1]) {
                    return swEnum;
                }
            }
        }
