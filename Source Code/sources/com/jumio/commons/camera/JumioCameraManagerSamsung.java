...
import com.samsung.android.sdk.camera.SCameraCaptureSession.CaptureCallback;
import com.samsung.android.sdk.camera.SCameraCaptureSession.StateCallback;
...
@TargetApi(22)
public class JumioCameraManagerSamsung extends JumioCameraManager implements OnImageAvailableListener {
    private static final String[] BLACKLIST = new String[]{"SC-04F", "SCL23", "SM-G900H", "SM-G9008W", "SM-G9009W", "SM-G900F", "SM-G900FQ", "SM-G900I", "SM-G900M", "SM-G900MD", "SM-G900T1", "SM-G900T4", "SM-G900R7", "SAMSUNG-SM-G900AZ", "SAMSUNG-SM-G900A", "SM-G900W8", "SM-G9006W", "SM-G900K", "SM-G900L", "SM-G900R6", "SM-G900S", "SM-G900P", "SM-S903VL", "SM-G900T", "SM-G900T3", "SM-G900R4", "SM-G900V", "SM-G900X", "SM-G906K", "SM-G906L", "SM-G906S", "SC-02G", "SM-G870F0", "SM-G870F", "SAMSUNG-SM-G870A", "SM-G870W", "SM-G900FD", "SM-G900FG", "SM-G860P", "SM-G901F", "SM-G800H", "SM-G800F", "SM-G800Y", "SM-G800R4", "SM-G903F", "NSM-G903M", "SM-G903W", "SM-G800HQ", "SM-G800M", "SAMSUNG-SM-G800A", "SM-G800X", "SM-G800Y"};
    private Handler backgroundHandler;
    private HandlerThread backgroundThread;
    private SCamera camera;
    private SCameraCaptureSession cameraCaptureSession;
    private SCameraCharacteristics cameraCharacteristics;
    private SCameraDevice cameraDevice;
    ...
    private class CaptureSessionCaptureCallback extends CaptureCallback {
        ...
        public void onCaptureCompleted(SCameraCaptureSession sCameraCaptureSession, SCaptureRequest sCaptureRequest, STotalCaptureResult sTotalCaptureResult) {
            if (JumioCameraManagerSamsung.this.manualFocusEnabled && JumioCameraManagerSamsung.this.focusing) {
                Integer num = (Integer) sTotalCaptureResult.get(SCaptureResult.CONTROL_AF_STATE);
                if (num == null) {
                    return;
                }
                if (num.intValue() == 4 || num.intValue() == 5) {
                    JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_TRIGGER, Integer.valueOf(2));
                    try {
                        JumioCameraManagerSamsung.this.setRepeatingRequest();
                    } catch (Throwable e) {
                        Log.printStackTrace(e);
                    }
                    JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_TRIGGER, Integer.valueOf(0));
                    JumioCameraManagerSamsung.this.focusing = false;
                }
            }
        }
    }
    ...
    private class CaptureSessionStateCallback extends StateCallback {
        ...
        public void onConfigured(SCameraCaptureSession sCameraCaptureSession) {
            if (JumioCameraManagerSamsung.this.cameraDevice != null) {
                JumioCameraManagerSamsung.this.cameraCaptureSession = sCameraCaptureSession;
                try {
                    if (JumioCameraManagerSamsung.this.focusModes.contains(Integer.valueOf(3))) {
                        JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_MODE, Integer.valueOf(3));
                        JumioCameraManagerSamsung.this.manualFocusEnabled = false;
                    } else if (JumioCameraManagerSamsung.this.focusModes.contains(Integer.valueOf(4))) {
                        JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_MODE, Integer.valueOf(4));
                        JumioCameraManagerSamsung.this.manualFocusEnabled = false;
                    } else if (JumioCameraManagerSamsung.this.focusModes.contains(Integer.valueOf(1))) {
                        JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_MODE, Integer.valueOf(1));
                        JumioCameraManagerSamsung.this.manualFocusEnabled = true;
                    } else if (JumioCameraManagerSamsung.this.focusModes.contains(Integer.valueOf(2))) {
                        JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_MODE, Integer.valueOf(2));
                        JumioCameraManagerSamsung.this.manualFocusEnabled = true;
                    } else if (JumioCameraManagerSamsung.this.focusModes.size() == 0) {
                        JumioCameraManagerSamsung.this.manualFocusEnabled = true;
                    }
                    JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.PHASE_AF_MODE, Integer.valueOf(1));
                    JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AE_MODE, Integer.valueOf(1));
                    JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_SCENE_MODE, Integer.valueOf(0));
                    JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AWB_MODE, Integer.valueOf(1));
                    JumioCameraManagerSamsung.this.previewRequestBuilder.set(SCaptureRequest.CONTROL_MODE, Integer.valueOf(1));
                    JumioCameraManagerSamsung.this.setRepeatingRequest();
                } catch (Throwable e) {
                    Log.printStackTrace(e);
                }
        ...
        public void onConfigureFailed(SCameraCaptureSession sCameraCaptureSession) {
            JumioCameraManagerSamsung.this.cameraCallback.onCameraError(null);
        }

        public void onClosed(SCameraCaptureSession sCameraCaptureSession) {
            JumioCameraManagerSamsung.this.cameraCaptureSession = null;
        }
    }

    private class DeviceStateCallback extends SCameraDevice.StateCallback {
        private DeviceStateCallback() {
        }

        public void onOpened(SCameraDevice sCameraDevice) {
            JumioCameraManagerSamsung.this.cameraOpenCloseLock.release();
            JumioCameraManagerSamsung.this.cameraDevice = sCameraDevice;
            JumioCameraManagerSamsung.this.createCameraPreviewSession();
            if (JumioCameraManagerSamsung.this.previewRequestBuilder != null) {
                if (JumioCameraManagerSamsung.this.isFlashSupported() && JumioCameraManagerSamsung.this.enableFlashOnStartUp) {
                    JumioCameraManagerSamsung.this.setFlash(true);
                }
                JumioCameraManagerSamsung.this.textureView.post(new Runnable() {
                    public void run() {
                        JumioCameraManagerSamsung.this.cameraCallback.onCameraAvailable(JumioCameraManagerSamsung.this.isFlashSupported());
                    }
                });
            }
        }
        ...
        public void onClosed(SCameraDevice sCameraDevice) {
            Log.d("onClosed");
            JumioCameraManagerSamsung.this.cameraOpenCloseLock.release();
            SDKUtil.setUsageLogger(null);
            JumioCameraManagerSamsung.this.cameraDevice = null;
        }
     ...
     */
        ...
        L_0x0012:
            r3 = com.jumio.commons.camera.JumioCameraManagerSamsung.this;
            r3.imageHandler = r2;
            return;
        L_0x0018:
        ...
        L_0x00ad:
            ...
            goto L_0x0077;
        L_0x00b3:
            r2 = com.jumio.commons.camera.JumioCameraManagerSamsung.this;	 Catch:{ Exception -> 0x00c9 }
        ...
        L_0x00d7:
            r2 = com.jumio.commons.camera.JumioCameraManagerSamsung.this;
            r3 = 0;
            r2.imageHandler = r3;
            return;
        L_0x00de:
        ...
        L_0x0115:
            ...
            throw r2;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.jumio.commons.camera.JumioCameraManagerSamsung.ImageHandler.run():void");
        }
    }
    ...
    JumioCameraManagerSamsung(TextureView textureView, ICameraCallback iCameraCallback, DeviceRotationManager deviceRotationManager, boolean z, boolean z2) {
    ...
    public static boolean hasSupportedCamera(Context context) {
        boolean z = false;
        try {
            if (!SsdkVendorCheck.isSamsungDevice() || Arrays.asList(BLACKLIST).contains(Build.MODEL)) {
                return false;
            }
            SCamera sCamera = new SCamera();
            sCamera.initialize(context);
            SCameraManager sCameraManager = sCamera.getSCameraManager();
            Size bestPreviewSize = getBestPreviewSize(((StreamConfigurationMap) sCameraManager.getCameraCharacteristics(sCameraManager.getCameraIdList()[0]).get(SCameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP)).getOutputSizes(SurfaceTexture.class));
    ...
    public static int getNumberOfCameras(Context context) {
        try {
            SCamera sCamera = new SCamera();
            sCamera.initialize(context);
            return sCamera.getSCameraManager().getCameraIdList().length;
    ...
    public boolean isFlashSupported() {
        return this.cameraCharacteristics != null ? ((Boolean) this.cameraCharacteristics.get(SCameraCharacteristics.FLASH_INFO_AVAILABLE)).booleanValue() : false;
    }
    ...
    public void setCameraFacing(boolean z) {
        this.cameraId = null;
        try {
            SCameraManager cameraManager = getCameraManager();
            int i = 0;
            while (i < cameraManager.getCameraIdList().length) {
                SCameraCharacteristics cameraCharacteristics = cameraManager.getCameraCharacteristics(cameraManager.getCameraIdList()[i]);
                this.frontFacing = ((Integer) cameraCharacteristics.get(SCameraCharacteristics.LENS_FACING)).intValue() == 0;
                if (z && this.frontFacing) {
                    this.cameraId = cameraManager.getCameraIdList()[i];
                    return;
                } else if (z || ((Integer) cameraCharacteristics.get(SCameraCharacteristics.LENS_FACING)).intValue() != 1) {
                    i++;
                } else {
                    this.cameraId = cameraManager.getCameraIdList()[i];
                    return;
    ...
    public void requestFocus(int i, int i2) {
        try {
            Rect rect = (Rect) this.cameraCharacteristics.get(SCameraCharacteristics.SENSOR_INFO_ACTIVE_ARRAY_SIZE);
            ...
            if (this.manualFocusEnabled) {
                if (!this.focusing) {
                    this.focusing = true;
                    this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_TRIGGER, Integer.valueOf(1));
                } else {
                    return;
                }
            }
            if (this.cameraCharacteristics.get(SCameraCharacteristics.CONTROL_MAX_REGIONS_AF) == null || ((Integer) this.cameraCharacteristics.get(SCameraCharacteristics.CONTROL_MAX_REGIONS_AF)).intValue() <= 0) {
                z = false;
            } else {
                this.previewRequestBuilder.set(SCaptureRequest.CONTROL_AF_REGIONS, new MeteringRectangle[]{new MeteringRectangle(rect2, 1000)});
            }
            if (z) {
                setRepeatingRequest();
            }
    ...
    public void setFlash(boolean z) {
        if (this.previewRequestBuilder != null && isFlashSupported()) {
            this.flashOn = z;
            this.previewRequestBuilder.set(SCaptureRequest.FLASH_MODE, Integer.valueOf(z ? 2 : 0));
            try {
                setRepeatingRequest();
            } catch (Throwable e) {
                Log.printStackTrace(e);
    ...
    public void stopPreview(boolean z) {
        ...
        if (this.cameraCaptureSession != null) {
            try {
                ...
                if (isFlashOn()) {
                    this.previewRequestBuilder.set(SCaptureRequest.FLASH_MODE, Integer.valueOf(0));
    ...
    private synchronized SCameraManager getCameraManager() {
        if (this.camera == null) {
            try {
                this.camera = new SCamera();
                this.camera.initialize(this.textureView.getContext());
            } catch (SsdkUnsupportedException e) {
                throw new CameraAccessException(e.getType(), e.getMessage());
            }
        }
        return this.camera.getSCameraManager();
    }
    ...
    private void setUpCameraOutputs() {
        try {
            ...
            ((Integer) this.cameraCharacteristics.get(SCameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL)).intValue();
            this.frontFacing = ((Integer) this.cameraCharacteristics.get(SCameraCharacteristics.LENS_FACING)).intValue() == 0;
            this.orientation = ((Integer) this.cameraCharacteristics.get(SCameraCharacteristics.SENSOR_ORIENTATION)).intValue();
            this.focusModes = new Vector();
            int[] iArr = (int[]) this.cameraCharacteristics.get(SCameraCharacteristics.CONTROL_AF_AVAILABLE_MODES);
            int length = iArr.length;
            while (i < length) {
                this.focusModes.add(Integer.valueOf(iArr[i]));
                i++;
            }
            StreamConfigurationMap streamConfigurationMap = (StreamConfigurationMap) this.cameraCharacteristics.get(SCameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP);
    ...
    private void openCamera(int i, int i2, boolean z, int i3) {
        ...
        try {
            if (this.cameraOpenCloseLock.tryAcquire(2500, TimeUnit.MILLISECONDS)) {
                getCameraManager().openCamera(this.cameraId, new DeviceStateCallback(), this.backgroundHandler);
                return;
            }
    ...
    L_0x007f:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jumio.commons.camera.JumioCameraManagerSamsung.createCameraPreviewSession():void");
    }
    ...
    L_0x017e:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jumio.commons.camera.JumioCameraManagerSamsung.configureTransform(int, int, boolean, int):void");
    }
}
