...
final class zzfv implements zzbe {
    ...
    private zzfv(zzfy zzfy, Context context, zzfx zzfx) {
        ...
        this.zzddt = String.format("%s/%s (Linux; U; Android %s; %s; %s Build/%s)", new Object[]{str, str2, str3, str4, str5, str6});
    }
    ...
    L_0x0028:
        r6 = 0;
        r7 = r10.zzktx;	 Catch:{ IOException -> 0x0083 }
        r5 = r7.zzc(r5);	 Catch:{ IOException -> 0x0083 }
        if (r3 == 0) goto L_0x003b;
    L_0x0031:
        r7 = r10.mContext;	 Catch:{ all -> 0x0038 }
        com.google.android.gms.tagmanager.zzdo.zzeo(r7);	 Catch:{ all -> 0x0038 }
        r3 = 0;
        goto L_0x003b;
    L_0x0038:
        r7 = move-exception;
    ...
    L_0x004e:
        ...
        com.google.android.gms.tagmanager.zzdj.zzcz(r6);	 Catch:{ all -> 0x006a }
        r6 = r10.zzkty;	 Catch:{ all -> 0x006a }
