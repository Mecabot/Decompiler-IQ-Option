...
public class zzc {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof zzc) {
            zzc zzc = (zzc) obj;
            if (zzbg.equal(Integer.valueOf(zzc.zzgch), Integer.valueOf(this.zzgch)) && zzbg.equal(Integer.valueOf(zzc.zzgci), Integer.valueOf(this.zzgci)) && zzc.zzfxb == this.zzfxb) {
                return true;
            }
        }
        return false;
    ...
    protected final Uri zzgk(String str) {
        str = this.zzfxb.zzd(str, this.zzgch, this.zzgci);
