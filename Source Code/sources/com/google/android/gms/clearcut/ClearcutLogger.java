...
public final class ClearcutLogger {
    ...
    public class LogEventBuilder {
        ...
        public void log() {
            ...
            this.zzfpu = true;
            zze zze = new zze(new zzbfv(ClearcutLogger.this.packageName, ClearcutLogger.this.zzfpc, this.zzfpe, this.zzfpd, this.zzfpf, this.zzfpg, ClearcutLogger.this.zzfph, 0), this.zzfpt, null, null, ClearcutLogger.zzb(null), null, ClearcutLogger.zzb(null), null, null, this.zzfps);
            zzbfv zzbfv = zze.zzfpz;
            if (ClearcutLogger.this.zzfpl.zzg(zzbfv.zzfpd, zzbfv.zzfpe)) {
                ClearcutLogger.this.zzfpj.zza(zze);
            } else {
