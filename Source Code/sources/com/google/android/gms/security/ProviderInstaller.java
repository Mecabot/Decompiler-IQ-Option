...
public class ProviderInstaller {
    ...
    public static void installIfNeeded(Context context) {
        ...
        synchronized (sLock) {
            try {
                if (zzkll == null) {
                    zzkll = context.getClassLoader().loadClass("com.google.android.gms.common.security.ProviderInstallerImpl").getMethod("insertProvider", new Class[]{Context.class});
                }
                zzkll.invoke(null, new Object[]{context});
            } catch (Exception e) {
