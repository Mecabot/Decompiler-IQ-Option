...
public class GoogleSignInOptions extends zzbgl implements Optional, ReflectedParcelable {
    ...
    @Nullable
    @Hide
    public static GoogleSignInOptions zzfb(@Nullable String str) {
    ...
    public boolean equals(Object obj) {
        ...
        try {
            ...
            if (this.zzeho != null ? !this.zzeho.equals(googleSignInOptions.zzeho) : googleSignInOptions.zzeho != null) {
                if (TextUtils.isEmpty(this.zzelb) ? !TextUtils.isEmpty(googleSignInOptions.zzelb) : !this.zzelb.equals(googleSignInOptions.zzelb)) {
                    if (this.zzenc == googleSignInOptions.zzenc && this.zzela == googleSignInOptions.zzela && this.zzenb == googleSignInOptions.zzenb) {
                        return true;
                    }
                }
            }
