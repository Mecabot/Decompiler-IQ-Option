...
public final class zzcjy {
    ...
    /* synthetic */ zzcjy(zzcju zzcju, String str, long j, zzcjv zzcjv) {
        this(zzcju, str, j);
    }
    ...
    public final void zzf(String str, long j) {
        ...
        j = this.zzjmi.zzbbd().getLong(this.zzjml, 0);
        if (j <= 0) {
            Editor edit = this.zzjmi.zzbbd().edit();
        ...
        long j2 = j + 1;
        Object obj = (this.zzjmi.zzayl().zzbcr().nextLong() & Long.MAX_VALUE) < Long.MAX_VALUE / j2 ? 1 : null;
        Editor edit2 = this.zzjmi.zzbbd().edit();
        if (obj != null) {
            edit2.putString(this.zzjmm, str);
        }
        edit2.putLong(this.zzjml, j2);
        edit2.apply();
    }
}
