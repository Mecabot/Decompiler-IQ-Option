...
final class zzfke implements Iterator<Entry<K, V>> {
    ...
    public final boolean hasNext() {
        return this.pos + 1 >= this.zzpss.zzpsl.size() ? !this.zzpss.zzpsm.isEmpty() && zzdbv().hasNext() : true;
    }
    ...
    public final /* synthetic */ Object next() {
        ...
        int i = this.pos + 1;
        this.pos = i;
        return (Entry) (i < this.zzpss.zzpsl.size() ? this.zzpss.zzpsl.get(this.pos) : zzdbv().next());
    }
