...
public final class zzciz {
    ...
    public static zzcja<Long> zzjiq = zzcja.zzb("measurement.config.cache_time", 86400000, 3600000);
    ...
    public static zzcja<Integer> zzjix = zzcja.zzm("measurement.upload.max_events_per_day", 100000, 100000);
    ...
    public static zzcja<Integer> zzjjc = zzcja.zzm("measurement.store.max_stored_events_per_app", 100000, 100000);
    ...
    public static zzcja<Long> zzjjf = zzcja.zzb("measurement.upload.window_interval", 3600000, 3600000);
    public static zzcja<Long> zzjjg = zzcja.zzb("measurement.upload.interval", 3600000, 3600000);
    ...
    public static zzcja<Long> zzjjt = zzcja.zzb("measurement.service_client.idle_disconnect_millis", 5000, 5000);
