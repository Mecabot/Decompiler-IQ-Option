...
final class zzcju extends zzcli {
    ...
    protected final void zzbap() {
        ...
        this.zzjlm = new zzcjy(this, "health_monitor", Math.max(0, ((Long) zzciz.zzjip.get()).longValue()), null);
    }
    ...
    final String zzjv(String str) {
        zzwj();
        str = (String) zzju(str).first;
        if (zzcno.zzeq("MD5") == null) {
            return null;
        }
        return String.format(Locale.US, "%032X", new Object[]{new BigInteger(1, zzcno.zzeq("MD5").digest(str.getBytes()))});
    }
