...
public abstract class zzfhu<MessageType extends zzfhu<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzfgj<MessageType, BuilderType> {
    ...
    static class zzc implements zzh {
        ...
        public final Object zzg(boolean z, Object obj, Object obj2) {
            if (z) {
                ...
                Object obj3 = 1;
                if (zzfhu != obj2) {
                    if (((zzfhu) zzfhu.zza(zzg.zzppz, null, null)).getClass().isInstance(obj2)) {
                        obj2 = (zzfhu) obj2;
    ...
    public static class zzb<T extends zzfhu<T, ?>> extends zzfgm<T> {
        ...
        public final /* synthetic */ Object zze(zzfhb zzfhb, zzfhm zzfhm) {
    ...
    public static abstract class zza<MessageType extends zzfhu<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzfgk<MessageType, BuilderType> {
        ...
        private final BuilderType zzd(zzfhb zzfhb, zzfhm zzfhm) {
            zzczv();
            try {
    ...
    protected static <T extends zzfhu<T, ?>> T zza(T t, zzfgs zzfgs) {
        ...
        byte byteValue;
        t = zza((zzfhu) t, zzfgs, zzfhm.zzczf());
        Object obj = null;
        if (t != null) {
            Object obj2;
            booleanValue = Boolean.TRUE.booleanValue();
            byteValue = ((Byte) t.zza(zzg.zzppt, null, null)).byteValue();
            if (byteValue == (byte) 1) {
                obj2 = 1;
            } else if (byteValue == (byte) 0) {
                obj2 = null;
            } else {
                obj2 = t.zza(zzg.zzppr, Boolean.FALSE, null) != null ? 1 : null;
                if (booleanValue) {
                    t.zza(zzg.zzppu, obj2 != null ? t : null, null);
                }
            }
            if (obj2 == null) {
                throw new zzfkm(t).zzdbz().zzi(t);
            }
        }
        if (t != null) {
            booleanValue = Boolean.TRUE.booleanValue();
            ...
            if (byteValue == (byte) 1) {
                ...
                if (t.zza(zzg.zzppr, Boolean.FALSE, null) != null) {
                    obj = 1;
                }
                if (booleanValue) {
                    t.zza(zzg.zzppu, obj != null ? t : null, null);
                }
            }
            if (obj == null) {
                throw new zzfkm(t).zzdbz().zzi(t);
    ...
    protected static <T extends zzfhu<T, ?>> T zza(T t, byte[] bArr) {
        t = zza((zzfhu) t, bArr, zzfhm.zzczf());
        if (t != null) {
            boolean booleanValue = Boolean.TRUE.booleanValue();
    ...
    protected static final <T extends zzfhu<T, ?>> boolean zza(T t, boolean z) {
        byte byteValue = ((Byte) t.zza(zzg.zzppt, null, null)).byteValue();
        return byteValue == (byte) 1 ? true : byteValue == (byte) 0 ? false : t.zza(zzg.zzppr, Boolean.FALSE, null) != null;
    }
    ...
    protected final boolean zza(int i, zzfhb zzfhb) {
        if ((i & 7) == 4) {
            return false;
        }
