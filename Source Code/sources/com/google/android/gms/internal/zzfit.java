...
public final class zzfit<K, V> {
    ...
    private static <T> T zza(zzfhb zzfhb, zzfhm zzfhm, zzfky zzfky, T t) {
    ...
    static <K, V> void zza(zzfhg zzfhg, zzfiv<K, V> zzfiv, K k, V v) {
        zzfhq.zza(zzfhg, zzfiv.zzpra, 1, k);
        zzfhq.zza(zzfhg, zzfiv.zzprc, 2, v);
    }

    public final void zza(zzfhg zzfhg, int i, K k, V v) {
        zzfhg.zzac(i, 2);
        zzfhg.zzlt(zza(this.zzpqz, (Object) k, (Object) v));
        zza(zzfhg, this.zzpqz, (Object) k, (Object) v);
    }

    public final void zza(zzfiw<K, V> zzfiw, zzfhb zzfhb, zzfhm zzfhm) {
