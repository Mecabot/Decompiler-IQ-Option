...
class m extends l {
    ...
    public static final <T> List<T> cs(T t) {
        return t != null ? l.cr(t) : emptyList();
    }

    public static final f L(Collection<?> collection) {
