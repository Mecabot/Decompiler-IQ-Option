...
public class q<T, R> extends s<R> implements l<T, R> {
    ...
    public q(KDeclarationContainerImpl kDeclarationContainerImpl, ad adVar) {
        h.e(kDeclarationContainerImpl, "container");
