...
public final class SingleFlatMapCompletable<T> extends a {
    ...
    static final class FlatMapCompletableObserver<T> extends AtomicReference<b> implements io.reactivex.b, b, q<T> {
    ...
    public SingleFlatMapCompletable(s<T> sVar, f<? super T, ? extends c> fVar) {
        this.source = sVar;
        this.mapper = fVar;
    }
