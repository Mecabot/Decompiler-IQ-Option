...
class d extends ContextWrapper {
    ...
    public File getDatabasePath(String str) {
        File file = new File(super.getDatabasePath(str).getParentFile(), this.ems);
        file.mkdirs();
    ...
    public File getFilesDir() {
        return new File(super.getFilesDir(), this.ems);
    }

    @TargetApi(8)
    public File getExternalFilesDir(String str) {
        return new File(super.getExternalFilesDir(str), this.ems);
    }

    public File getCacheDir() {
        return new File(super.getCacheDir(), this.ems);
    }

    @TargetApi(8)
    public File getExternalCacheDir() {
        return new File(super.getExternalCacheDir(), this.ems);
    }

    public SharedPreferences getSharedPreferences(String str, int i) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(this.emt);
