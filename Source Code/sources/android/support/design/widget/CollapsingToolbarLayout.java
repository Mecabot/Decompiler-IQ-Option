    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mCollapsingTitleEnabled && this.mDummyView != null) {
            ...
            if (this.mDrawCollapsingTitle) {
                ...
                i6 += titleMarginEnd;
                titleMarginEnd = (this.mTmpRect.top + systemWindowInsetTop) + this.mToolbar.getTitleMarginTop();
                ...
                collapsingTextHelper.setCollapsedBounds(i6, titleMarginEnd, i7 + titleMarginStart, (this.mTmpRect.bottom + systemWindowInsetTop) - this.mToolbar.getTitleMarginBottom());
                this.mCollapsingTextHelper.setExpandedBounds(obj != null ? this.mExpandedMarginEnd : this.mExpandedMarginStart, this.mTmpRect.top + this.mExpandedMarginTop, (i3 - i) - (obj != null ? this.mExpandedMarginStart : this.mExpandedMarginEnd), (i4 - i2) - this.mExpandedMarginBottom);
                this.mCollapsingTextHelper.recalculate();
            }
        }
        systemWindowInsetTop = getChildCount();
        for (int i8 = 0; i8 < systemWindowInsetTop; i8++) {
