...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f7 = f5 / ((this.mRawShadowSize - (this.mRawShadowSize * SHADOW_HORIZ_SCALE)) + f5);
        float f8 = f5 / ((this.mRawShadowSize - (this.mRawShadowSize * SHADOW_TOP_SCALE)) + f5);
        float f9 = f5 / ((this.mRawShadowSize - (this.mRawShadowSize * SHADOW_BOTTOM_SCALE)) + f5);
    ...
    private void buildShadowCorners() {
        ...
        float f4 = rectF.top;
        paint2.setShader(new LinearGradient(0.0f, f4, 0.0f, rectF2.top, new int[]{this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, SHADOW_HORIZ_SCALE, SHADOW_BOTTOM_SCALE}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
