...
public class Fragment implements LifecycleOwner, ViewModelStoreOwner, ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public final FragmentActivity zzakw() {
    ...
    public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenuInfo contextMenuInfo) {
        zzakw().onCreateContextMenu(contextMenu, view, contextMenuInfo);
    }
    ...
    void performCreate(Bundle bundle) {
        ...
        if (this.mCalled) {
            this.mLifecycleRegistry.b(Event.ON_CREATE);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
    ...
    void performStart() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.b(Event.ON_START);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
    ...
    void performResume() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.b(Event.ON_RESUME);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
    ...
    void performPause() {
        this.mLifecycleRegistry.b(Event.ON_PAUSE);
        if (this.mChildFragmentManager != null) {
    ...
    void performStop() {
        this.mLifecycleRegistry.b(Event.ON_STOP);
        if (this.mChildFragmentManager != null) {
    ...
    void performDestroy() {
        this.mLifecycleRegistry.b(Event.ON_DESTROY);
        if (this.mChildFragmentManager != null) {
