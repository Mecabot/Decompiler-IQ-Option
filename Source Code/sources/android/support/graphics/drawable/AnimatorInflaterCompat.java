...
public class AnimatorInflaterCompat {
    ...
    private static void setupPathMotion(Path path, ObjectAnimator objectAnimator, float f, String str, String str2) {
        ...
        while (true) {
            ...
            i = arrayList.size();
            if (i3 < i) {
                i = (f3 > ((Float) arrayList.get(i3)).floatValue() ? 1 : (f3 == ((Float) arrayList.get(i3)).floatValue() ? 0 : -1));
                if (i > 0) {
                    i = ((Float) arrayList.get(i3)).floatValue();
                    f3 -= i;
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        int i = 0;
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(obtainAttributes, xmlPullParser, b.VALUE, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        ...
        if (obj != null) {
            if (i != 3) {
                switch (i) {
                    case 0:
                        ofFloat = Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser, b.VALUE, 0, 0.0f));
                        break;
                    case 1:
                        break;
                    default:
            ...
            ofFloat = Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, b.VALUE, 0, 0));
        } else if (i == 0) {
