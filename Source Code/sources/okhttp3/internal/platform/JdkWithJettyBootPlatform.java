...
class JdkWithJettyBootPlatform extends Platform {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:4:0x002d A:{Splitter: B:1:0x0004, ExcHandler: java.lang.reflect.InvocationTargetException (r6_1 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:4:0x002d, code:
            r6 = move-exception;
     */
    ...
    public void configureTlsExtensions(javax.net.ssl.SSLSocket r6, java.lang.String r7, java.util.List<okhttp3.Protocol> r8) {
        ...
        r8 = r8.getClassLoader();	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r0 = 2;
        r1 = new java.lang.Class[r0];	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r2 = r5.clientProviderClass;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r3 = 0;
        r1[r3] = r2;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r2 = r5.serverProviderClass;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r4 = 1;
        r1[r4] = r2;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r2 = new okhttp3.internal.platform.JdkWithJettyBootPlatform$JettyNegoProvider;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r2.<init>(r7);	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r7 = java.lang.reflect.Proxy.newProxyInstance(r8, r1, r2);	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r8 = r5.putMethod;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r1 = 0;
        r0 = new java.lang.Object[r0];	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r0[r3] = r6;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r0[r4] = r7;	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        r8.invoke(r1, r0);	 Catch:{ InvocationTargetException -> 0x002d, InvocationTargetException -> 0x002d }
        return;
    L_0x002d:
        r6 = move-exception;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:3:0x000d A:{Splitter: B:0:0x0000, ExcHandler: java.lang.IllegalAccessException (r5_1 'e' java.lang.Exception)} */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:3:0x0076 A:{Splitter: B:0:0x0000, ExcHandler: java.lang.ClassNotFoundException (unused java.lang.ClassNotFoundException)} */
