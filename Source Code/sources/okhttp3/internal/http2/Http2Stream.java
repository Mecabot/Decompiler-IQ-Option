...
public final class Http2Stream {
     ...
     */
        /* JADX WARNING: Missing block: B:17:0x007a, code:
            monitor-enter(r10);
     */
        /* JADX WARNING: Missing block: B:19:?, code:
     ...
     */
        /* JADX WARNING: Missing block: B:20:0x009b, code:
     ...
     */
        /* JADX WARNING: Missing block: B:22:0x00b1, code:
            monitor-exit(r10);
     */
        ...
        void receive(BufferedSource bufferedSource, long j) {
            while (j > 0) {
                ...
                synchronized (Http2Stream.this) {
                    z = this.finished;
                    obj = null;
                    obj2 = j + this.readBuffer.size() > this.maxByteCount ? 1 : null;
                }
                if (obj2 != null) {
