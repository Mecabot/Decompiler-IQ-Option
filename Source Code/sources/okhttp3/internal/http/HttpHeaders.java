...
public final class HttpHeaders {
    ...
    public static boolean hasBody(Response response) {
        ...
        if (((code >= 100 && code < 200) || code == 204 || code == MobileEvents.EVENTTYPE_RAW_TOUCH) && contentLength(response) == -1 && !"chunked".equalsIgnoreCase(response.header("Transfer-Encoding"))) {
            return false;
        }
        return true;
    }
