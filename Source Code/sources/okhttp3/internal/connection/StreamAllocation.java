    ...
    private RealConnection findConnection(int i, int i2, int i3, int i4, boolean z) {
        ...
        synchronized (this.connectionPool) {
            ...
            try {
                ...
                realConnection2 = 
/*
Method generation error in method: okhttp3.internal.connection.StreamAllocation.findConnection(int, int, int, int, boolean):okhttp3.internal.connection.RealConnection, dex: classes3.dex
jadx.core.utils.exceptions.CodegenException: Error generate insn: ?: MERGE  (r0_7 'realConnection2' okhttp3.internal.connection.RealConnection) = (r0_6 'realConnection2' okhttp3.internal.connection.RealConnection), (r6_5 'socket' okhttp3.internal.connection.RealConnection) in method: okhttp3.internal.connection.StreamAllocation.findConnection(int, int, int, int, boolean):okhttp3.internal.connection.RealConnection, dex: classes3.dex
